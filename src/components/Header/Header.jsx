      ...
      <MediaQuery minWidth={1025}>
        <Container fluid className='header-pc'>
          ...
          <div className='header-comp-pc'>
            ...
            <h5 onClick={()=>{window.location.href='/Contact'}}>Contact</h5>
        ...
        <Container style={{backgroundColor:'#1687a7'}} fluid>
          ...
          {option?
            <div className='navbar-mobile-menu'>
              <div className='menu-mobile-item' onClick={()=>{window.location.href='/'}}> 
                <h6>Home</h6>
              </div>
              <div className='menu-mobile-item-line'></div>
              
              <div className='menu-mobile-item' onClick={()=>{window.location.href='/Contact'}}> 
                <h6>Contact</h6>
              </div>
              <div className='menu-mobile-item-line'></div>
